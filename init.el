...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lua-mode racket-mode tempel cape corfu gruvbox-theme zenburn-theme zenburn embark-consult embark consult marginalia orderless vertico nov web-mode which-key pdf-tools rainbow-delimiters paredit geiser-chicken magit)))
(custom-set-faces
